# Generated by Django 3.2.7 on 2021-11-06 11:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('futnitur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.furnituremodels')),
                ('keranjang', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.shoppingcartmodels')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
